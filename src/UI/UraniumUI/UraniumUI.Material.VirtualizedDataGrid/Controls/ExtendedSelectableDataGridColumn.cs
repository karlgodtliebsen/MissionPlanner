...
public class ExtendedSelectableDataGridColumn : DataGridColumn, IDataGridSelectionColumn
{
    ...
    private static BindingBase? TryCloneBinding(BindingBase? binding)
    {
        ...
        try
        {
            return binding.CopyAsClone();
        }
        catch (NotSupportedException)
        {
            // TypedBinding instances generated by x:DataType cannot be cloned.
            // SelectionMemberPath is the repeatable alternative for row state.
            return null;
        }
    }
