...
public sealed class FirmwarePanelRequest(FirmwarePanelAction action, CancellationToken cancellationToken)
{
    ...
    public static Task SendAsync(Action<FirmwarePanelRequest>? handler, FirmwarePanelAction action, CancellationToken token)
    {
        token.ThrowIfCancellationRequested();
        var request = new FirmwarePanelRequest(action, token);
