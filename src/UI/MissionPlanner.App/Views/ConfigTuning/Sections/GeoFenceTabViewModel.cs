...
public sealed partial class GeoFenceTabViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(GeoFenceTabViewModel.DownloadCommand), nameof(GeoFenceTabViewModel.UploadCommand), nameof(GeoFenceTabViewModel.ClearVehicleCommand))]
    ...
    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(GeoFenceTabViewModel.RestoreBackupCommand))]
    ...
    {
        OnActiveVehicleChangedAsync(e).SafeFireAndForget();
    }
