...
public sealed record FirmwareBoardTarget
{
    ...
    public FirmwareBoardTarget(int boardId, string platform, FirmwareVehicleType vehicleType, FirmwareVehicleType mavType, IEnumerable<UsbIdentifier>? usbIdentifiers = null, IEnumerable<string>? bootloaderNames = null)
    {
        if (boardId <= 0)
        {
    ...
    public FirmwareVehicleType VehicleType
    {
        get;
    }

    public FirmwareVehicleType MavType
    {
        get;
    }

    /// <summary>Gets known USB identifiers.</summary>
    public IReadOnlyList<UsbIdentifier> UsbIdentifiers
    {
        get;
    }

    /// <summary>Gets known bootloader names.</summary>
    public IReadOnlyList<string> BootloaderNames
    {
        get;
    }
}
