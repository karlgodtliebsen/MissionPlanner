...
public class MissionProtocolMapperTests
{
    ...
    public static TheoryData<MissionItem> RoundTripItems => new()
    {
        new WaypointMissionItem(MissionItemId.New(), 1, new GeoPosition(55.1234567, 10.7654321),
            ...
            AcceptanceRadiusMeters: 2, PassRadiusMeters: 1, DesiredYawDegrees: 90),
        ...
        new LandMissionItem(MissionItemId.New(), 7, new GeoPosition(55.6, 10.6),
            new MissionAltitude(0, MissionAltitudeReference.Home), AbortAltitudeMeters: 15, DesiredYawDegrees: 180),
        new TakeoffMissionItem(MissionItemId.New(), 8, null,
            new MissionAltitude(40, MissionAltitudeReference.Home), PitchDegrees: 10, HeadingDegrees: 45),
        ...
        new ChangeSpeedMissionItem(MissionItemId.New(), 11, MissionSpeedType.Airspeed, 18, ThrottlePercent: 75)
    };
