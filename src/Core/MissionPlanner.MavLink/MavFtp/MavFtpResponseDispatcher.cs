...
/// 
/// </summary>
public sealed class MavFtpResponseDispatcher : IMavFtpResponseDispatcher, IDisposable
{
    ...
    public MavFtpResponseDispatcher(IEventHub eventHub, IMavFtpPacketCodec codec, ILogger<MavFtpResponseDispatcher> logger)
    {
        this.codec = codec;
        this.logger = logger;
    ...
    public MavFtpResponseRegistration Register(MavFtpTarget target, ushort requestSequence, MavFtpOpcode requestedOpcode, byte? session = null, bool multipleResponses = false)
    {
        ...
        var registration = new MavFtpResponseRegistration(target, requestSequence, requestedOpcode, session, multipleResponses, 128, () => registrations.TryRemove(id, out var _));
