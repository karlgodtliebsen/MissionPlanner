...
public interface ISitlInstallationService
{
    ...
    Task<IReadOnlyList<SitlManifestEntry>> GetReleasesAsync(FirmwareFamily family, FirmwareReleaseChannel channel, CancellationToken cancellationToken = default);
    ...
    Task<SitlInstallation> InstallAsync(SitlManifestEntry release, IProgress<double>? progress = null, CancellationToken cancellationToken = default);
    ...
    SitlInstallationResolution Resolve(SimulatorProfile profile, IReadOnlyList<SitlInstallation> installations);
}
