...
public sealed partial class CubeLanPortViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    public partial bool ClassOfServiceEnabled
    {
        get; set;
    }
    ...
    [ObservableProperty]
    public partial bool ClassOfServiceHighPriority
    {
        get; set;
    }
    ...
    [ObservableProperty]
    public partial bool EnergyEfficientEthernetEnabled
    {
        get; set;
    }
    ...
    [ObservableProperty]
    public partial bool VlanTagged
    {
        get; set;
    }

    /// <summary>Gets the eight VLAN destination memberships.</summary>
    public ObservableCollection<CubeLanMembershipViewModel> Memberships
    {
        get;
    }
}
