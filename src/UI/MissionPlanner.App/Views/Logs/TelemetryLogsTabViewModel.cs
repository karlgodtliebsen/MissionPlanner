...
public sealed partial class TelemetryLogsTabViewModel : ViewModelBase
{
    ...
    /// <param name="clipboard">Platform clipboard boundary for complete log snapshots.</param>
    ...
    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(TelemetryLogsTabViewModel.LoadCommand), nameof(TelemetryLogsTabViewModel.PlayPauseCommand), nameof(TelemetryLogsTabViewModel.SeekCommand), nameof(TelemetryLogsTabViewModel.CloseReplayCommand), nameof(TelemetryLogsTabViewModel.ApplySpeedCommand))]
