...
public sealed partial class OnboardOsdTabViewModel : ViewModelBase
{
    ...
    public OnboardOsdTabViewModel(
        ...
        IUserConfirmationService confirmation, ILogger<OnboardOsdTabViewModel> logger) : base(logger)
    {
    ...
    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(OnboardOsdTabViewModel.MoveLeftCommand), nameof(OnboardOsdTabViewModel.MoveRightCommand), nameof(OnboardOsdTabViewModel.MoveUpCommand), nameof(OnboardOsdTabViewModel.MoveDownCommand))]
    ...
    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(OnboardOsdTabViewModel.ApplyScreenCommand), nameof(OnboardOsdTabViewModel.ResetScreenCommand), nameof(OnboardOsdTabViewModel.ImportCommand), nameof(OnboardOsdTabViewModel.ExportCommand))]
