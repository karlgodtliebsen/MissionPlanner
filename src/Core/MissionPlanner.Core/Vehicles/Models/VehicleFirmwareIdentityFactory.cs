...
public static class VehicleFirmwareIdentityFactory
{
    ...
    public static VehicleFirmwareIdentity FromHeartbeat(byte mavType, byte autopilot)
    {
        return new VehicleFirmwareIdentity(MapFamily(mavType, autopilot), mavType, autopilot, null, null, 0, 0, 0, 0, null, null);
    }
    ...
    {
        return ((MavLink.Generated.MavType)mavType).ToFirmwareFamily((MavLink.Generated.MavAutopilot)autopilot);
    }
    ...
    /// <returns>The mapped family, or <see cref="FirmwareFamily.Unknown"/>.</returns>
    public static FirmwareFamily MapFamily(MavLink.Generated.MavType mavType, MavLink.Generated.MavAutopilot autopilot)
    {
        return mavType.ToFirmwareFamily(autopilot);
    }
}
