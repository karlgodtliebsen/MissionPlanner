...
public sealed class DfuDeviceItemViewModel
{
    ...
    public DfuDeviceDescriptor Descriptor
    {
        get;
    }
    ...
    {
        return $"{Descriptor.ProductName ?? "STM32 Bootloader"} · VID_{Descriptor.VendorId:X4}&PID_{Descriptor.ProductId:X4} · {DriverText(Descriptor.DriverState)}";
    }

    private static string DriverText(DfuDriverState state)
    {
        return state switch
        {
