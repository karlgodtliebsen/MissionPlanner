...
public partial class PayloadControlTabViewModel : ViewModelBase
{
    ...
    public PayloadControlTabViewModel(IActiveVehicleContext active, IVehicleComponentRegistry components,
        ICameraProtocolService cameras, IGimbalProtocolService gimbals, ILogger<PayloadControlTabViewModel> logger)
        : base(logger)
    {
        this.active = active;
